...
# latex builder
# those (optional) requires are missing on rhel6 they were
%if 0%{?rhel} > 6
...
* Mon Jun 19 2017 Charalampos Stratakis <cstratak@redhat.com> - 1.2.3-1
- Update to 1.2.3 for rh-python36

* Wed Jan 21 2015 Robert Kuska <rkuska@redhat.com> 1.2.2-2
- Make requires for texlive conditional
